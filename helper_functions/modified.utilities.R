...
getFREDnoWget <- function(url, destinationfile = 'here.txt', freq = "Quarterly", convert2tif = TRUE) {
  ##########################################################################################
...
#readFREDrawData <- function(url, destinationfile = 'here.txt', freq = "Quarterly") {
